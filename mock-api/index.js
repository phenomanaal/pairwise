...
const writeExternalFile = (filePath, newFile) => {
  ...
  if (existingFileIndex !== -1) {
    ...
    externalFiles[existingFileIndex] = Object.assign(
      Object.assign({}, externalFiles[existingFileIndex]),
      newFile,
    );
...
server.post('/pairwise/login', (request, reply) =>
...
server.post('/pairwise/verify-access-code', (request, reply) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
server.post('/pairwise/file', (request, reply) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _a, e_1, _b, _c;
    ...
    try {
      for (
        var _d = true, parts_1 = __asyncValues(parts), parts_1_1;
        (parts_1_1 = yield parts_1.next()), (_a = parts_1_1.done), !_a;
        _d = true
      ) {
        _c = parts_1_1.value;
        _d = false;
